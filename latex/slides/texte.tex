...
\begin{frame}
\frametitle{The Elasto$\Phi$ project: the context} 
%\framesubtitle{}


%\begin{figure}
%\centering
%\includegraphics[width=0.25\textwidth]{Figures/ischemique.png} \qquad
%\includegraphics[width=0.25\textwidth]{Figures/hemorragique2.png} 
%\end{figure}
...
% \sum_{\tau\in\mathcal{T}}\sum_{\tau'\in\mathcal{T}}\int_{\tau\times\tau'}\mathscr{R}_{\tau}^{\by}(\mathscr{R}_{\tau'}^{\bx}\mathscr{G}(\bx-\by)) \bu(\bx)\bv(\by) d\sigma(\bx) d\sigma(\by).
